  ...
  return (
    <div className="p-4 lg:p-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-2xl p-4 lg:p-8 shadow-md">
        ...
        <div className="space-y-4 lg:space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="p-4 lg:p-6 bg-white rounded-2xl shadow-md">
              <div className="flex items-center gap-2 mb-2">
                <PhilippinePeso className="w-4 h-4 lg:w-5 lg:h-5 text-[#D4A156]" />
                <p className="text-xs lg:text-sm text-[#A8A8A8]">Total Spent</p>
              </div>
              <p className="text-[#5C5C5C] text-xl lg:text-2xl font-medium">
            ...
            <div className="p-4 lg:p-6 bg-white rounded-2xl shadow-md">
              <div className="flex items-center gap-2 mb-2">
                <ShoppingBag className="w-4 h-4 lg:w-5 lg:h-5 text-[#D4A156]" />
            ...
            <div className="p-4 lg:p-6 bg-white rounded-2xl shadow-md">
              <div className="flex items-center gap-2 mb-2">
                <CalendarClock className="w-4 h-4 lg:w-5 lg:h-5 text-[#D4A156]" />
                <p className="text-xs lg:text-sm text-[#A8A8A8]">
                  Member Since
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-7">
            <div className="bg-white rounded-2xl p-4 lg:p-8 shadow-md w-full">
              <div className="flex items-center gap-2 lg:gap-3 mb-4 lg:mb-5">
                <User className="w-4 h-4 lg:w-5 lg:h-5 text-[#D4A156]" />
                <h3 className="text-lg lg:text-xl text-[#5C5C5C]">
                  Account Information
                </h3>
              </div>
            ...
            <div className="bg-white rounded-2xl p-4 lg:p-8 shadow-md w-full">
              <div className="flex items-center gap-2 lg:gap-3 mb-4 lg:mb-5">
                <LockKeyhole className="w-4 h-4 lg:w-5 lg:h-5 text-[#D4A156]" />
                <h3 className="text-lg lg:text-xl text-[#5C5C5C]">
                  Change Password
                </h3>
              </div>
